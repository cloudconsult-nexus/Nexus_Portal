...
function NavList({ items, user, accentColor }) {
    ...
    <div className="min-h-screen flex bg-surface">
      <aside className="w-64 shrink-0 bg-ink text-white flex flex-col">
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          <NavList items={topNav} user={user} accentColor={branding.accentColor} />

          <div className="pt-4 mt-2 border-t border-white/10">
            <p className="px-3 pb-1.5 pt-3 text-[15px] font-semibold tracking-tight">OnCall Pro</p>
            <NavList items={onCallProNav} user={user} accentColor={branding.accentColor} />
          </div>

          <div className="pt-4 mt-2 border-t border-white/10">
            <NavList items={bottomNav} user={user} accentColor={branding.accentColor} />
          </div>
        </nav>
